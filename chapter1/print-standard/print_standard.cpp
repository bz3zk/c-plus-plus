// This program prints the C++ language standard your compiler us currently using
#include <iostream>

const int numStandards = 7;
// The C++26 stdCode is a placholder since the exact code won't be determined until the standard is finalized
